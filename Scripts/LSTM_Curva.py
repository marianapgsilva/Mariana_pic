"""
BariCurve - LSTM temporal com dias reais desde a cirurgia
=========================================================
...
CAMINHO_MODELO_TEMPORAL = os.path.join(PASTA_MODELS, "modelo_lstm_temporal.keras")
CAMINHO_SCALER_X_TEMPORAL = os.path.join(PASTA_MODELS, "scaler_x_temporal.pkl")
CAMINHO_SCALER_Y_TEMPORAL = os.path.join(PASTA_MODELS, "scaler_y_temporal.pkl")
CAMINHO_METADATA_TEMPORAL = os.path.join(PASTA_MODELS, "metadata_lstm_temporal.pkl")
...
def carregar_modelo_temporal():
    if not os.path.exists(CAMINHO_MODELO_TEMPORAL):
        raise FileNotFoundError(
            ...
            "previsao_peso_2026_versao2.0/Scripts/LSTM_Curva.py"
        )
